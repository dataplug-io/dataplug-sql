...
class SqlSerializer {
  ...
  serializeData (data, collectionPrefix = undefined, collectionMetadata = undefined, queries = undefined) {
    ...
    // const sortedEntities = _.keys(data).sort((l, r) => {
    //   const lMetadata
    // })
    ...
    _
      .keys(data)
      .sort((l, r) => {
        const lMetadata = (collectionMetadata ? collectionMetadata[l] : undefined) || data[l].metadata
        const rMetadata = (collectionMetadata ? collectionMetadata[r] : undefined) || data[r].metadata
